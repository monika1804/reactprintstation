...
import './shopping.css';
import {motivationalquoteframewithpostersData} from "./motivationalquote_data"
import {BrowserRouter as Router,Switch,Link} from "react-router-dom";
import { Carousel } from 'react-bootstrap';
  

function Planners(){
    let [carousel, setCarousel] = useState(motivationalquoteframewithpostersData[0])
    const handleImageClick=(e, key)=> {
        setCarousel(motivationalquoteframewithpostersData[key])
    }
...
<div class="imgonclick">
    {motivationalquoteframewithpostersData.map((images, key) => {
...
<h6 style={{'color':'black'}}>{carousel.description9}</h6><br/>
