...
export default function Uploader({update, setUpdate}) {
  ...
  return (
    <>
    <PrintIcon style={{fontSize:'6.00rem',color:'#a00000',}}/>
    <Box>
      <h3 class="display-4 p-2" style={{fontSize:'3vw',}}>Click to upload pdf/doc/ppt</h3>
      <Box sx = {{display: "flex", flexDirection: "row", justifyContent: "center", mt: "10px", mb: "10px"}}>
        <input 
          ...
          ref = {inputFileRef}
        />
        <Button class="buttonprint" disabled = {fileUploading} sx = {{width: "150px"}} variant = "contained" onClick = { e => inputFileRef.current.click()}>
          Upload
        </Button>
      </Box>
